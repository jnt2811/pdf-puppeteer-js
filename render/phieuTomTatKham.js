...
//       <div class="foot">
//         <div>
//           <div>Số thẻ BHYT:<span class="bold"> ${data.bao_hiem.so_the}</span></div>
//           <div>Đối tượng: <span class="bold"> ${data.bao_hiem.doi_tuong}</span></div>
//         </div>
//         <div class="hoaDon">
//           <div>Hạn thẻ đến: ${data.bao_hiem.han_the_den}</div>
//           <div>Khám ngày: <span class="bold"> 07:51 - 13/01/2022</span></div>
//         </div>
//       </div>
//     </div>
//     <div class="line"></div>
